function ToastMessage(text, toast) {
    ...
    this.openToast = function () {
        ...
        toast.innerHTML = `
<svg class="toast-${this.toast}-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
  ${html}
</svg>
